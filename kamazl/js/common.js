...
jQuery(function(){
 ...
 document.querySelectorAll(".brands__item").forEach((brands__item) => observer.observe(brands__item));

/*----------------------------------------*/
gsap.registerPlugin(ScrollTrigger);
var mySplitText = new SplitText(".box-slider__text span", {type:"chars,words, lines"}),
tl = new TimelineLite();
tl.staggerFrom(mySplitText.chars, 0.5, {y:20, opacity:0}, 0.04)


const listItems = Array.from(document.getElementsByClassName("box"));
